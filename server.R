...
shinyServer(function(input, output) {
  ...
  output$boxplot = renderPlot({
    ...
    d[giorni_mare>(input_check_gio()-1) & id_strato==input_strato() & var==input_var() ,ggplot(.SD, aes(x= var,y=value)) +geom_boxplot(outlier.size=3 ,outlier.colour="red", fill="grey",colour = "blue") + xlab("")]
